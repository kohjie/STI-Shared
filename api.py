...
class ApiRos:
    ...
    def printIp(self):
        self.inputsentence = ["/ip/address/print/count"]
        self.writeSentence(self.inputsentence)
        self.readSentence()
    ...
    def updateIp(self, numbers, address):
    ...
    def deleteIp(self, index):
        self.inputsentence = ["/ip/address/remove"]
        self.inputsentence.append("=numbers=" + index)
        self.writeSentence(self.inputsentence)
        self.readSentence()
...
def main():
    ...
    #apiros.updateIp(sys.argv[2], sys.argv[3]);
